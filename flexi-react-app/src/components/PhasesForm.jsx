    ...
    <div className="p-1 bg-white rounded-lg shadow-sm border">
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-2">
        <div className="space-y-2">
                       <h3 className="text-[10px] font-semibold text-gray-900 border-b pb-2">Informazioni Fase</h3>
        ...
        {department === DEPARTMENT_TYPES.PRINTING && (
          <div className="space-y-2">
                         <h3 className="text-[10px] font-semibold text-gray-900 border-b pb-2">Parametri Stampa</h3>
        ...
        {department === DEPARTMENT_TYPES.PACKAGING && (
          <div className="space-y-2">
                         <h3 className="text-[10px] font-semibold text-gray-900 border-b pb-2">Parametri Confezionamento</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
              <div className="space-y-2">
          ...
          <div className="space-y-2">
                       <h3 className="text-[10px] font-semibold text-gray-900 border-b pb-2">Descrizione Fase</h3>
          <div className="space-y-2">
